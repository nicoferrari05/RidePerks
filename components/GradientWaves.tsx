...
// React Bits — GradientWaves (JS/CSS variant), ported to TypeScript for
// this project. Logic is unchanged from the upstream component; only
// typing was added so it compiles under strict TS, plus this project's
// own default color/motion props are supplied where it's used (Hero).
